/*
* Kod för webbshop, av Ashraf Hamadi, THG
* E-post: ashraf.hamadi@edu.stockholm.se
* OBS: Denna kod får ej användas utanför projektuppgifter för kursen Webbutveckling II
* Har du gjort ändringar i denna fil ska detta beskrivas här i sidhuvudet.
* 
* Ändringar gjorda: 
 smallBasketEl - tar bort summa så att den inte syns vid den lilla varukorgen 
 + lagt till mellanrum mellan den lilla varukorgen samt antal varor
*/
...
function addToBasket(el, id, name, cost, image, notify = true) {
    ...
    if (notify == true) {
        ...
        if (document.getElementById("notify")) {
            var notifyText = "<p>Varan <b>" + name + "</b> lagd i varukorgen rtertret</p>";
